...
class Client():
    def __init__(self,H=None,p=None,i=None,e=None,t=None,s=None,d=None,f=None, parameters = None, port = 3001):
    ...
    def respond_to_server(self):
        if not self.so: return
        try:
            value = repr(self.R).encode('utf-8') 
            self.so.sendto(value, (self.host, self.port))
        except socket.error as emsg:
    ...
    def restart_race(self):
        self.R.set_reset(True)
        self.respond_to_server()
        self.R.set_reset(False)
